...
exports.initialize = function (nowjs) {
  ...
  var User = function (socket) {
    ...
    socket.on('data', function(msg) {
        ...
        if(msg.type == 'rfc') {
        ...
        } else if(msg.type == 'rv' && nowjs.options.clientWrite) {
          ...
          for (var i = 0, ll = keys.length; i < ll ; i++) {
            ...
            self.emit('change: '+fqn, data[fqn]);
          }
        } else if(msg.type == 'del' && nowjs.options.clientWrite) {
